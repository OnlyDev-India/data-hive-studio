//! The sign in database work (spec 0010). [`Store::sign_in`] gathers the
//! facts, carries the outcome out in one transaction, and retries once if
//! another request made the same account a moment earlier. The pure
