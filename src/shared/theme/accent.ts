...
const ACCENTS: Accent[] = [
  ...
  },
  {
    id: "purple",
    name: "Purple",
    base: "oklch(0.55 0.22 290)",
    foreground: "oklch(0.985 0 0)",
  },
  {
    id: "pink",
    name: "Pink",
    base: "oklch(0.6 0.2 350)",
    foreground: "oklch(0.985 0 0)",
  },
  {
    id: "red",
    name: "Red",
    base: "oklch(0.57 0.22 25)",
    foreground: "oklch(0.985 0 0)",
  },
  {
    id: "orange",
    name: "Orange",
    base: "oklch(0.65 0.19 55)",
    foreground: "oklch(0.985 0 0)",
  },
  {
    id: "yellow",
  ...
  },
  {
    id: "green",
    name: "Green",
    base: "oklch(0.6 0.19 150)",
    foreground: "oklch(0.985 0 0)",
  },
  {
    id: "teal",
    name: "Teal",
    base: "oklch(0.62 0.16 190)",
    foreground: "oklch(0.985 0 0)",
  },
];
...
export function readAccent(): AccentId {
  ...
  return ACCENTS.some((a) => a.id === stored)
    ? (stored as AccentId)
    : "graphite";
}
